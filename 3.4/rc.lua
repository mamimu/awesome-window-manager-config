...
membar:set_background_color("#333333")
membar:set_border_color("#0a0a0a")
membar:set_color("#0a0a0a")
...
cpugraph:set_color("#0a0a0a")
cpugraph:set_border_color("#0a0a0a")
cpugraph:set_gradient_colors({ "#222222", "#285577", "#285577" })
